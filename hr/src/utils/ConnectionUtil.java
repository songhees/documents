...
/**
 * JDBMS 드라이버를 등록하고, RDBMS와 연결된 Connection 객체를 제공하는 유틸리티 클래스다.
 * @author OhSong
 *
 */
public class ConnectionUtil {
	...
	/*
	 *  정적 초기화 블록  
	 *  객체 생성과 상관없이 클래스가 메모리에 로딩될 때 즉시 실행된다.
	 *  클래스가 메모리에 로딩되는 시점은 수행문에 클래스 이름이 등장하는 순간이다.
	 ...
	 * @return RDBMS와 연결을 담당하는 Conncetion 객체
