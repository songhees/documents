...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark my-3">
	<div class="container-fluid">
    	...
    	<div class="collapse navbar-collapse" id="collapsibleNavbar">
      		<ul class="navbar-nav">
        		<li class="nav-item"><a class="nav-link active" href="/food-app/home.jsp">홈</a></li>
		        ...
		        <li class="nav-item dropdown">
		          	<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">고객관리</a>
		          	<ul class="dropdown-menu">
