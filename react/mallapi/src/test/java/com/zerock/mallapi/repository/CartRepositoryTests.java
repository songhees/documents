...
public class CartRepositoryTests {
    ...
    public void testInsertByProduct() {
        ...
        CartItem cartItem = cartItemRepository.getCartItemByEmailAndProuct(email, pno);
    ...
    public void testListOfMember() {
        ...
        List<CartItemListDTO> cartItemList = cartItemRepository.getCartItemListDTOByEmail(email);
    ...
    public void testDeleteThenList() {
        ...
        //장바구니 번호
        Long cno = cartItemRepository.getCartNo(cino);

        //삭제
        //cartItemRepository.deleteById(cino);

        //목록
        List<CartItemListDTO> cartItemList = cartItemRepository.getCartItemListDTOByCart(cno);
