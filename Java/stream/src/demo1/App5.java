...
public class App5 {
	public static void main(String[] args) {
		...
		// .count() : 스트림의 요소갯수를 반환한다. .min() / .max() : 스트림 요소의 최소값/최대값을 반환한다.
		...
		// .collect() : 스트림의 각 요소를 수집한다. List, Set등의 형태로 반환한다.
		List<Integer> numList = Stream.of(4, 2, 7, 6, 8, 1, 5).collect(Collectors.toList());
		Set<Integer> numSet = Stream.of(4, 2, 7, 6, 8, 1, 5).collect(Collectors.toSet());
