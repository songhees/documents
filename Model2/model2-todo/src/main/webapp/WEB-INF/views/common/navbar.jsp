	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<!--  
					1. HttpSession객체에 loginUser 라는 속성명으로 조회되는 객체가 존재하는지를 체크해서
					   로그인전/로그인후 메뉴가 다르게 노출되도록 한다.
					   ${not empty loginUser}는 loginUser속성명으로 조회했을 때 객체가 존재할 때 true를 반환한다. - 로그인이 완료된 경우
					   ${empty loginUser}는 loginUser속성명으로 조회했을 때 객체가 존재하지 않으면 true를 반환한다. - 로그인하지 않는 경우 
					2. 
				-->
