...
public class StudentApp {
	public static void main(String[] args) {
		 ...
		 *	4. Student객체의 생성이 완료되면, 생성자 메소드를 실행해서 객체 생성 직후에 수행할 직업을 실행시킨다.
		 *	5. Student객체의 주소값이 참조변수 student1에 대입된다.
		 */
		Student student1 = new Student();
		/* Student 객체 생성하기
		 * 
		 * 	1. new 키워드 다음에 생성자 메소드를 적는다. 2번은 한번 loading됐으므로 또 하지 않는다.
		 *	3. 메모리에 로딩된 실행파일(Student.class)을 설계도 삼아서 Student객체를 생성한다.
		 *	4. Student객체의 생성이 완료되면, 생성자 메소드를 실행해서 객체 생성 직후에 수행할 직업을 실행시킨다.
		...
		// 매개변수가 있는 생성자 메소드 실행시키기
		Student student3 = new Student(100, "컴퓨터공학과", 3, "류관순", "ruy@gmail.com", "010-1111-3333");
		
		Student student4 = new Student(200, "환경공학과", 2, "이순신", "lee@gmail.com", "010-1111-4444");
		...
		Student student6 = new Student("영어영문학과", "강감찬", "010-7895-6124");
